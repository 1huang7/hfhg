...
class QiandongnanTourismApp {
    ...
    handleAttractionHover(event) {
        ...
        if (badge) {
            badge.style.boxShadow = '0 0 20px rgba(26, 188, 156, 0.6)';
        }
        card.style.boxShadow = '0 15px 40px rgba(26, 188, 156, 0.2)';
    }
    ...
    handleRouteHover(event) {
        ...
        item.style.boxShadow = '0 5px 20px rgba(26, 188, 156, 0.2)';
    }
    ...
    // 切换舞阳河详细介绍
    toggleWuyangheDetails() {
        const detail = document.getElementById('wuyanghe-detail');
        const btn = document.querySelector('[onclick="toggleWuyangheDetails()"]');
    ...
    // 切换肇兴梯田详细介绍
    toggleZhaoxingDetails() {
        const detail = document.getElementById('zhaoxing-detail');
        const btn = document.querySelector('[onclick="toggleZhaoxingDetails()"]');
    ...
    // 切换肇兴侗寨详细介绍
    toggleZhaoxingVillageDetails() {
        const detail = document.getElementById('zhaoxing-village-detail');
        const btn = document.querySelector('[onclick="toggleZhaoxingVillageDetails()"]');
    ...
    // 切换西江千户苗寨详细介绍
    toggleXijiangDetails() {
        const detail = document.getElementById('xijiang-detail');
        const btn = document.querySelector('[onclick="toggleXijiangDetails()"]');
    ...
    // 切换镇远古城详细介绍
    toggleZhenyuanDetails() {
        const detail = document.getElementById('zhenyuan-detail');
        const btn = document.querySelector('[onclick="toggleZhenyuanDetails()"]');
...
function toggleWuyangheDetails() {
    if (window.qiandongnanApp) {
        window.qiandongnanApp.toggleWuyangheDetails();
    }
}

function toggleZhaoxingDetails() {
    if (window.qiandongnanApp) {
        window.qiandongnanApp.toggleZhaoxingDetails();
    }
}

function toggleZhaoxingVillageDetails() {
    if (window.qiandongnanApp) {
        window.qiandongnanApp.toggleZhaoxingVillageDetails();
    }
}

function toggleXijiangDetails() {
    if (window.qiandongnanApp) {
        window.qiandongnanApp.toggleXijiangDetails();
    }
}

function toggleZhenyuanDetails() {
    if (window.qiandongnanApp) {
        window.qiandongnanApp.toggleZhenyuanDetails();
    }
}

// 页面加载完成后初始化
document.addEventListener('DOMContentLoaded', () => {
    window.qiandongnanApp = new QiandongnanTourismApp();
