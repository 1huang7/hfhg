...
class BijieTourismApp {
    ...
    // 切换百里杜鹃详细介绍
    toggleBailiDetails() {
        const detail = document.getElementById('baili-detail');
        const btn = document.querySelector('[onclick="toggleBailiDetails()"]');
    ...
    // 切换威宁草海详细介绍
    toggleWeiningDetails() {
        const detail = document.getElementById('weining-detail');
        const btn = document.querySelector('[onclick="toggleWeiningDetails()"]');
    ...
    // 切换纳雍九洞天详细介绍
    toggleJiudongDetails() {
        const detail = document.getElementById('jiudong-detail');
        const btn = document.querySelector('[onclick="toggleJiudongDetails()"]');
    ...
    // 切换韭菜坪详细介绍
    toggleJiucaiDetails() {
        const detail = document.getElementById('jiucai-detail');
        const btn = document.querySelector('[onclick="toggleJiucaiDetails()"]');
    ...
    // 切换乌江百里画廊详细介绍
    toggleWujiangDetails() {
        const detail = document.getElementById('wujiang-detail');
        const btn = document.querySelector('[onclick="toggleWujiangDetails()"]');
    ...
    // 切换织金洞详细介绍
    toggleZhijinDetails() {
        const detail = document.getElementById('zhijin-detail');
        const btn = document.querySelector('[onclick="toggleZhijinDetails()"]');
...
document.addEventListener('DOMContentLoaded', () => {
    window.bijieApp = new BijieTourismApp();
...
// 全局函数，供HTML调用
function toggleBailiDetails() {
    if (window.bijieApp) {
        window.bijieApp.toggleBailiDetails();
    }
}

function toggleWeiningDetails() {
    if (window.bijieApp) {
        window.bijieApp.toggleWeiningDetails();
    }
}

function toggleJiudongDetails() {
    if (window.bijieApp) {
        window.bijieApp.toggleJiudongDetails();
    }
}

function toggleJiucaiDetails() {
    if (window.bijieApp) {
        window.bijieApp.toggleJiucaiDetails();
    }
}

function toggleWujiangDetails() {
    if (window.bijieApp) {
        window.bijieApp.toggleWujiangDetails();
    }
}

function toggleZhijinDetails() {
    if (window.bijieApp) {
        window.bijieApp.toggleZhijinDetails();
    }
}